...
class product
{
      ...
      void showall(int c)
      {
            cout<<"  "<<prodid<<setw(15)<<name<<setw(11)<<company<<setw(11)<<"Php."<<price<<setw(10)<<qty<<setw(13)<<dis<<"%"<<endl;
      }
      int retpno()
      {
           return prodid;
...
void place_order()
{
      ...
      if(value==1)
      {
            ...
            for(int x=0;x<c;x++)
            {
                  ...
                  damt=amt-o1[x].dis1;
                  cout<<"  "<<ptx[x]<<setw(10)<<o1[x].pname1<<setw(9)<<o1[x].qty1<<setw(12)<<"Php."<<o1[x].price1<<setw(10)<<"Php."<<amt<<setw(14)<<"Php."<<damt<<endl;
                  total+=damt;
                   //ttaxt+=o1[x].tax1;
                  yy++;
             }
             ...
             cout<<"-------------------------------------------------------------------------"<<endl;
             yy++;
             cout<<"		  NET TOTAL        :   "<<"Php."<<(total+((ttaxt*total)/100))<<endl;
             yy++;
             cout<<"		  ROUND OFF AMOUNT :   "<<"Php."<<setprecision(2)<<(round(total+((ttaxt*total)/100))-(total+((ttaxt*total)/100)))<<endl;
             cout<<"		  NET AMOUNT DUE   :   "<<"Php."<<fixed<<round(total+((ttaxt*total)/100))<<endl<<endl;
             cout<<"-------------------------------------------------------------------------"<<endl;
             cout<<"		   P A Y M E N T  S U M M A R Y  "<<endl;
             cout<<"-------------------------------------------------------------------------"<<endl;
             cout<<"		  Enter CASH value :   Php.";
             float vb,xy;
             cin>>vb;
             ...
             {
                cout<<"	     Change to be returned :   Php."<<xy<<endl;
                changeqty(pr1,q1);
                cout<<"-------------------------------------------------------------------------"<<endl;
...
void intro()
{
      ...
      cout<<"-------------------------------------------------------------------------"<<endl;
      cout<<"PROJECT CREATE BY :                                                      "<<endl;
      cout<<"                       PIES ITSOURCECODE                                 "<<endl;
      cout<<endl;
      cout<<"========================================================================="<<endl;
      cin.get();
}
...
void mainMenu(){
     char ch;
      do
      {
                  cout<<endl;
                  cout<<"-------------------------------------------------------------------------"<<endl;
                  cout<<"*********   RESTAURANT  M A N A G E M E N T  S Y S T E M      ***********"<<endl;
                  cout<<"-------------------------------------------------------------------------"<<endl;
                  cout<<endl;
            cout<<"=============================   MAIN MENU   ============================"<<endl;
